...
export function About() {
    return (
        <div id="About" className='py-10 px-6 sm:px-10 lg:px-20'>
            <h2 className="text-4xl font-bold mt-4">About Biomass Pellets</h2>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-12 mt-8">
                <div className="w-full lg:w-1/2">
                    ...
                    {titles.map((item, index) => (
                        <div className='flex flex-col justify-between mt-4 rounded-2xl py-4 pr-4 hover:bg-green-600/20 hover:pl-4 transition-all duration-300' key={index}>
                            <div className='flex gap-3 sm:gap-4'>
                                <div className='h-12 w-12 sm:h-14 sm:w-14 flex justify-center items-center bg-green-300 rounded-full shrink-0'>
                                    {item.icon}
                                </div>
                                <div className='flex flex-col'>
                                    <h3 className='font-bold text-lg sm:text-xl'>{item.title}</h3>
                                    <p className='text-black/80 text-sm sm:text-base pt-1'>{item.desc}</p>
                                </div>
                            </div>
                        </div>
                    ))}
                ...
                <div className="w-full lg:w-1/2">
                    <div className='lg:pl-12 xl:pl-20 relative'>
                        ...
                        <div className='absolute bottom-4 right-4 sm:bottom-0 sm:right-0 sm:translate-y-1/4 sm:translate-x-1/4 bg-white shadow-2xl rounded-2xl hover:scale-105 transition-all duration-300'>
                            <div className='p-3 sm:p-4 flex items-start gap-2 sm:gap-3'>
                                <div className='h-10 w-10 sm:h-12 sm:w-12 flex justify-center items-center bg-green-300 rounded-full shrink-0'>
